            ...
            <div>
                ...
                <div className="row center-xs">
                    <div className="col-xs-16 col-sm-12 col-md-12">
                        <div className="section__description">Although it is not easy to make ideas and construct prototypes weekly, implementation is the most obvious way to deliver more vividly. Because design results will speak for themselves than any resources and explanations for design process. Followings are the results from inspiration and ideation mentioned above.
                        </div>
                    </div>
                </div>
                <div className="row">
                    ...
                    <div className="row">
                        <div className="col-xs-24 col-md-24">
                            <div className="row center-xs game_transition_status">
                                {[trans_status1, trans_status2, trans_status3, trans_status4, trans_status5].map((img, i)=>
                ...
                <div className="col-xs-24 col-md-24">
                    ...
                    <div className="row project2__navigation">
                        <div className="ratio__inner ratio__inner--overflow row middle-xs">
                            <div className="col-xs-5 col-md-5 col-xs-offset-3 col-md-offset-3" style={style.channelMainPhone}>
                                <div className="row center-xs">
                    ...
                    <div className="row project2__gesture">
                        <div className="ratio__inner row">
                            <div className="col-xs-11 col-md-11 col-xs-offset-6 col-md-offset-6">
                                <img className="ratio__img" src={depth_view} alt=""/>
                            </div>
                        </div>
                        <div className="ratio__inner row bottom-xs center-xs">
                            <div className="col-xs-4 col-md-4" style={style.depth_view}>
                        ...
                        <div className="col-xs-22 col-md-22 col-xs-offset-1 col-md-offset-1">
                            <div className="project3">
                                ...
                                <div className="row center-xs">
                                    <div className="col-xs-10 col-md-10">
                                        <div className="phone-landscape live_phone">
                                            <img className="ratio__img live_icon live_icon--left" src={live_icon1} alt=""/>
                                ...
                                <div className="row center-xs">
                                    <div className="col-xs-10 col-md-10">
                                        <div className="phone-landscape live_phone">
                                            <img className="ratio__img live_icon live_icon--right" src={live_icon2} alt=""/>
                                            <div className="ratio__inner live_phone__inner">
                                                <video className="ratio__img" autoPlay playsInline="" muted="" loop poster="">
                                ...
                                <div className="row center-xs">
                                    <div className="col-xs-10 col-md-10">
                                        <div className="phone-landscape live_phone">
                                            <img className="ratio__img live_icon live_icon--left" src={live_icon3} alt=""/>
                                            <div className="ratio__inner live_phone__inner">
                                ...
                                <div className="row center-xs">
                                    <div className="col-xs-10 col-md-10">
                                        <div className="phone-landscape live_phone">
                                            <img className="ratio__img live_icon live_icon--right" src={live_icon4} alt=""/>
                                            <div className="ratio__inner live_phone__inner">
                                                <video className="ratio__img" autoPlay playsInline="" muted="" loop poster="">
