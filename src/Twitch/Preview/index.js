      ...
      <div className="row center-xs">
        <div className="col-xs-22 col-sm-16">
          <SectionDescription>
            ...
            this, it is able to add a real-time response to the video through
            ...
            projected on the image while the existing image has unilaterally
        ...
        <div className="col-xs-10 col-sm-8 col-xs-offset-1 col-sm-offset-1">
          <div className="idea">
            ...
            <ArticleParagraph className="desc desc--below">
              ...
              in that it helps to distinguish between "event indicator" and
              "universal attention" that should be of interest to the video. I
              designed this new-type idiom and named it a "Volume-Bias" chart.
            </ArticleParagraph>
          </div>
        </div>
      </div>
        ...
        <div className="col-xs-22 col-sm-14">
          <div className="idea">
            <ArticleParagraph className="desc">
              ...
              <b>chat</b>. A video is generated by only one event at a time, the
              result of which is a series of successive events. Chat, the
              ...
              continuously. I could use it to 'look like a sequential', but I
              ...
              separately in an interactive way.
            </ArticleParagraph>
          </div>
        </div>
      </div>
      ...
      <div className="row center-xs middle-xs">
        ...
        <div className="col-xs-10 col-sm-8">
          <ArticleParagraph>
            ...
            the cases: [1] Include only one keyword. [2] Include more than one
            ...
            (sentences). Therefore, in the case of [2], the feed was classified
            by keyword with the highest ranking(The mostly mentioned keyword).
            In the case of [3], it was excluded from the visualization because
            it could create a misunderstanding in the purpose of helping the
            viewer through the 'sentence containing meaningful contents’.
          </ArticleParagraph>
        </div>
        ...
        <div className="col-xs-20 col-sm-8 col-sm-offset-1">
          <ArticleParagraph>
            ...
            <br />
            <i>
              2. Because the limitation of the screen size, data cannot be shown
              at a glance.
            </i>
            <br />
            <br />
            This project provides a range slider to control the stacked bar
            graph and provide the interface from '1px per second' to
            'Full-screen height as a whole video segment length'.
            <br />
            <br />
          </ArticleParagraph>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-xs-5 col-xs-offset-1">
          <ArticleParagraph>
            ...
            the keyword in the selection are represented in the treemap.
          </ArticleParagraph>
        </div>
      </div>
