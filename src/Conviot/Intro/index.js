      ...
      <div className="row center-xs middle-xs full-height">
        <div className="col-xs">
          <div className="row start-xs">
            <div className="col-xs-6 col-md-6 col-xs-offset-3 col-md-offset-3">
              <div className="program__title">CONVIoT</div>
            </div>
            <div className="col-xs-11 col-md-11 col-xs-offset-1 col-md-offset-1">
        ...
        <div className="col-xs-14 col-md-14 col-xs-offset-3 col-md-offset-3">
          <div className="wall1">
            <div className="ratio__inner cross--cyan">
              <img
                className="ratio__img wall1_img wall1_img--blur"
                src={intro_wall1}
                alt=""
              />
            </div>
        ...
        <div className="col-xs-20 col-md-20 col-xs-offset-2 col-md-offset-2">
          <div className="wall2">
            <div className="ratio__inner cross--purple">
              <img
                className="ratio__img wall2_img wall2_img--blur"
                src={intro_wall2}
                alt=""
              />
            </div>
