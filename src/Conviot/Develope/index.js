    ...
    return (
        <div>
                ...
                <div className="row middle-xs ratio__inner">
                    <div className="col-xs">
                        <div className="row center-xs">
                            <div className="col-xs">
                                <div className="section__title">Develope</div>
                            </div>
                        </div>
                        <div className="row center-xs">
                            <div className="col-xs-12 col-md-12">
                                <div className="section__description">For user to access platform easily, many aspects of functions needs to be hidden. It means convenient service makes user to think what they can do, not how to do. To achieve this goal, I developed with two principles - scalability and explainablity.</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="pageMainBg">
                        <div className="ratio__inner">
                            <svg width="100%" height="100%" viewBox="0 0 2400 1000">
                                <defs>
                                    <linearGradient id="pageMainGradient" gradientUnits="userSpaceOnUse" x1="2049.6487" y1="-351.3515" x2="352.3516" y2="1345.9456">
                                        <stop  offset="0" style={{stopColor:"#41B3CA"}}/>
                                        <stop  offset="1" style={{stopColor:"#6451D0"}}/>
                                    </linearGradient>
                                </defs>
                                <path fill="url(#pageMainGradient)" d="M2401,994.594c0,0-400-199.084-1200-199.084S1,994.594,1,994.594V0h2400V994.594z"/>
                            </svg>
                        </div>
            ...
            <div className="row middle-xs">
                <div className="col-xs-9 col-md-9 col-xs-offset-4 col-md-offset-4">
                    <div className="row center-xs">
                        <div className="article__title component_title">
                            Condition
                        </div>
            ...
            <div className="row">
                <div className="col-xs-8 col-md-8 col-xs-offset-3 col-md-offset-3">
                    <div className="transition_effect shadow">
                        <div className="ratio__inner">
                            <video className="ratio__img shadow" autoPlay playsInline="" muted="" loop poster="">
