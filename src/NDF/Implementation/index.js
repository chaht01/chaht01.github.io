        ...
        <div className="row center-xs">
          <div className="col-xs-16 col-sm-12 col-md-12">
            <div className="section__description">
              Although it is not easy to make ideas and construct prototypes
              weekly, implementation is the most obvious way to deliver more
              vividly. Because design results will speak for themselves than any
              resources and explanations for the design process. Followings are
              the results from inspiration and ideation mentioned above.
            </div>
          </div>
        </div>
        <div className="row">
            ...
            <div className="col-xs-24 col-md-24">
              <div className="row center-xs game_transition_status">
                {[
                  ...
                  <div
                    key={i}
                    className="col-xs-3 col-md-3 game_transition_status__item"
                  >
                  ...
                  <svg height="100%" width="100%">
                    <defs>
                      ...
                      >
                        <stop
                          offset="0%"
                          style={{ stopColor: "#f66241", stopOpacity: 1 }}
                        />
                        <stop
                          offset="100%"
                          style={{ stopColor: "#f6a741", stopOpacity: 1 }}
                        />
                      </linearGradient>
                    </defs>
          ...
          <div className="row bottom-xs project">
            ...
            <div className="col-xs col-sm-8 col-sm-offset-3">
              ...
              <div className="project__desc">
                <span className="project__name">Tools</span>
                <span className="project__item">
                  Illustrator, AfterEffect, Framer, Keynote
                </span>
              </div>
              <div className="project__desc">
                <span className="project__name">Team</span>
